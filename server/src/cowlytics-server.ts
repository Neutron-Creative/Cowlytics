...
/**
 * The Cowlytics Server contains a Fastify instance and a list of Controllers, which registers routes with Fastify.
 */
export class CowlyticsServer {
    ...
    */
    startServer() {
        ...
        console.log("Cowlytics is mooing!");
    }
